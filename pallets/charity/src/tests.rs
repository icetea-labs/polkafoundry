use crate::{self as charity, Config, Event as RawEvent};
use frame_support::{
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Charity: charity::{Pallet, Call, Storage, Event<T>},
	}
);
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	GenesisBuild::<TestRuntime>::assimilate_storage(&crate::GenesisConfig {}, &mut t).unwrap();
